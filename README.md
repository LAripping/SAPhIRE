...
|         #0|20:27:48.93                                      |
|        GET|www.ratpack.gr /sports/story/4758/10-pragmata... |
| ----------+---------------------------------------------... |
|     cookie|IN_HASH=ampshare%3Dhttp%3A%2F%2Fwww.ratpack.g... |
 _____________________________________________________________ 
                                                                _________________________________________________________ 
                                                              |   200 OK                                                 |
                                                              |  ----------------------------------------------------... |
                                                              |  resp_header|x-powered-by=php/5.6.26 x-micro-cache=hi... |
                                                                _________________________________________________________ 
...
| ----------+---------------------------------------------... |
|        url|wt=framework type=widgetJSTracking trackingIn... |
|     cookie|bscookie="v=1&20170103174718edc72a8e-4b42-48f... |
 _____________________________________________________________ 
                                                                _________________________________________________________ 
                                                              |   200                                                    |
                                                              |  ----------------------------------------------------... |
                                                              |  resp_header|x-li-uuid=ueuungbz8hrafmawqisaaa== x-li-... |
                                                                _________________________________________________________ 


 _____________________________________________________________ 
|         #2|20:27:48.32                                      |
|       POST|zdwidget3-bs.sphereup.com /zoomd/SearchUi/Get... |
| ----------+---------------------------------------------... |
 _____________________________________________________________ 
                                                                _________________________________________________________ 
...
| ----------+---------------------------------------------... |
 _____________________________________________________________ 
                                                              ...
                                                              |   200 OK                                                 |
                                                              |  ----------------------------------------------------... |
                                                              |  resp_header|x-aspnetmvc-version=5.2 x-aspnet-version... |
                                                                _________________________________________________________ 


 _____________________________________________________________ 
|         #6|20:27:48.74                                      |
|       POST|prod-sb-appanalytics-us1.servicebus.windows.n... |
| ----------+---------------------------------------------... |
| req_header|authorization=sharedaccesssignature sr=prod-s... |
 _____________________________________________________________ 
                                                                _________________________________________________________ 
                                                              |   201 Created                                            |
                                                              |  ----------------------------------------------------... |
...
| ----------+---------------------------------------------... |
|        url|family=Roboto:100,100i,300,300i,400,400i,500,... |
| req_header|x-chrome-uma-enabled=1 x-client-data=cje2yqei... |
 _____________________________________________________________ 
                                                                _________________________________________________________ 
                                                              |   200                                                    |
                                                              |  ----------------------------------------------------... |
                                                              |  resp_header|link=<https://fonts.gstatic.com>; rel=pr... |
                                                                _________________________________________________________ 
